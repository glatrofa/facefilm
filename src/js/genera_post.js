...
function generaFooter(idPost, idSerie, numeroLike, numeroDislike, numeroCommenti) {
    ...
    let footer = "<div class='card-footer'>" +
                    ...
                    "<span class='badge badge-pill bg-awwa-primary mr-2' id='"+ idPost +"-post_comment_number'>"+ numeroCommenti +"</span><a class='card-link awwa-primary post' id='"+ idPost +"' name='post_comment' data-toggle='modal' data-target='modal_commenti' href=''><i class='fa fa-diamond'></i> Commenta</a>" +
                "</div></div>";                
    return footer;
}
