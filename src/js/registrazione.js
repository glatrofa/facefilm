...
let modalRegistrazioneSuccess = "<div class='modal-dialog modal-dialog-centered modal-sm' role='document'>" +
                                  "<div class='modal-content'>" + 
                                    ...
                                    "<div class='modal-footer'>" + 
                                      "<button type='button' class='btn btn-form-primary' onclick='redirectRegistrazioneSuccess()'>Vai a login</button>" + 
                                      "<button type='button' class='btn btn-form-secondary' data-dismiss='modal'>Chiudi</button>" + 
                                    "</div>" + 
                                  "</div>";
